...
<title>Certifications &amp; Standards - Harris Thermal</title>
<meta name="description" content="ASME U, R, and PP stamps, PED/CE mark, Canadian CRN, TEMA, and API 620/650/660 — the certifications behind every Harris Thermal build.">
...
.px-hero .bg{position:absolute;inset:0;background:url('/sites/harristhermal/wp-content/uploads/2022/06/24912-003-1-scaled.jpg') center/cover no-repeat;z-index:-2;transform:scale(1.04);animation:px-kb 16s ease-in-out infinite alternate}
...
<meta property="og:title" content="Certifications &amp; Standards - Harris Thermal">
...
<meta property="og:description" content="ASME U, R, and PP stamps, PED/CE mark, Canadian CRN, TEMA, and API 620/650/660 — the certifications behind every Harris Thermal build.">
<script type="application/ld+json">{"@@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"/"},{"@type":"ListItem","position":2,"name":"Certifications & Standards","item":"/certifications/"}]}</script>
</head>
<body>
...
<section class="px-hero">
  ...
  <div class="ht-wrap">
    <div class="px-hero-inner">
      <span class="px-eyebrow">About Us · Certifications</span>
      <h1>Compliance is the floor, <em>not the ceiling.</em></h1>
      <p class="lead">With over 140 years of experience, we manufacture custom heat exchangers, pressure vessels, and process equipment to the highest standards of safety, performance, and reliability.</p>
      <div class="px-ctas">
        <a class="px-btn px-btn-primary" href="/get-a-quote/">Get a Quote</a>
        <a class="px-btn px-btn-ghost" href="#certs">Our Certifications</a>
      </div>
    </div>
  </div>
</section>

<section class="px-block" id="certs">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal"><div class="px-kicker">Certifications</div><h2>Stamped, marked, and registered.</h2></div>
    <div class="px-types">
      <div class="px-type px-reveal"><h3>ASME Certifications</h3><ul>
        <li><strong>ASME &ldquo;U&rdquo; Stamp</strong>Fabrication of pressure vessels per ASME Section VIII, Division 1</li>
        <li><strong>ASME &ldquo;R&rdquo; Stamp</strong>National Board authorization for repair and alteration of pressure vessels</li>
        <li><strong>ASME B31.1 &ldquo;PP&rdquo; Stamp</strong>Power piping certification for boiler external piping and high-pressure systems</li>
      </ul></div>
      <div class="px-type px-reveal"><h3>International Compliance</h3><ul>
        <li><strong>PED &ldquo;CE&rdquo; Mark</strong>Pressure Equipment Directive certification for equipment supplied into the EU</li>
        <li><strong>Canadian CRN</strong>Registered and approved to supply pressure equipment throughout Canada</li>
      </ul></div>
      <div class="px-type px-reveal"><h3>Industry Standards</h3><ul>
        <li><strong>TEMA</strong>Full compliance with Tubular Exchanger Manufacturers Association standards</li>
        <li><strong>API 620 / 650 / 660</strong>Storage tanks, large welded low-pressure vessels, and heat exchangers to API standards</li>
      </ul></div>
    </div>
  </div>
</section>
<section class="px-block soft">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal"><div class="px-kicker">Quality Assurance &amp; Testing</div><h2>Verified before it ships.</h2><p>Certifications are milestones in an ongoing journey of improvement — each one reinforces our commitment to safer practices and more reliable equipment. For guidance on a specific code requirement, <a href="/contact-us/">connect with our quality team</a>.</p></div>
    <div class="px-mats px-reveal"><h3>QA &amp; Testing Capabilities</h3><ul><li>Positive material identification — in-house Nitron</li><li>Helium leak testing — in-house</li><li>Liquid penetrant — in-house Level II &amp; III</li><li>Radiography — in-house CR Level III</li><li>Ultrasonic testing — Level II in-house</li><li>Physical testing — certified laboratory</li><li>Hydrostatic &amp; pneumatic testing</li><li>Complete material traceability</li></ul></div>
...
<section class="ht-cta-band" style="margin-top:0">
  <div class="ht-wrap">
    <div>
      <h2>Need a specific code requirement met?</h2>
      <p>Our quality team can walk you through stamps, marks, and registrations for your jurisdiction and application.</p>
    </div>
    <div class="ht-ctas">
