...
<title>Materials - Harris Thermal</title>
<meta name="description" content="Harris Thermal stocks and fabricates stainless steels, duplex, nickel alloys, Hastelloy, Inconel, Monel, titanium, zirconium, tantalum, and clad materials.">
...
<meta property="og:title" content="Materials - Harris Thermal">
<meta property="og:url" content="/materials/">
<meta property="og:image" content="/sites/harristhermal/wp-content/uploads/2022/06/harris_pressure_vessel-scaled.jpg">
<meta property="og:description" content="Harris Thermal stocks and fabricates stainless steels, duplex, nickel alloys, Hastelloy, Inconel, Monel, titanium, zirconium, tantalum, and clad materials.">
<script type="application/ld+json">{"@@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"/"},{"@type":"ListItem","position":2,"name":"Materials","item":"/materials/"}]}</script>
</head>
<body>
...
<section class="px-hero">
  ...
  <div class="ht-wrap">
    <div class="px-hero-inner">
      <span class="px-eyebrow">Capabilities · Materials</span>
      <h1>The hardest metals, <em>handled with ease.</em></h1>
      <p class="lead">In 135 years we have formed, machined, and welded an extremely wide variety of materials — including customer-specific proprietary alloys — backed by R&amp;D that lets us take on the most challenging metallurgy.</p>
      <div class="px-ctas">
        <a class="px-btn px-btn-primary" href="/get-a-quote/">Get a Quote</a>
        <a class="px-btn px-btn-ghost" href="#materials">Materials We Work</a>
      </div>
    </div>
  </div>
</section>
...
<section class="px-block">
  <div class="ht-wrap px-split">
    <div class="px-reveal">
      <div class="px-kicker">Stocked &amp; Ready</div>
      <h2>Buying smart, so you save.</h2>
      <p>We stock a wide variety of materials, purchased at opportune times to bring savings to our customers — and to enable emergency deliveries when your schedule demands it.</p>
      <p>Our research and development gives us unique capability to successfully weld, machine, and form the most challenging materials, from reactive metals to high-nickel alloys.</p>
    </div>
    <div class="px-photo px-reveal">
      <img src="/sites/harristhermal/wp-content/uploads/2022/06/20211229_093743-1.jpg" alt="Alloy heat exchanger fabrication" loading="lazy">
      <div class="px-badge"><div class="n">135+ yrs</div><div class="l">Metallurgy experience</div></div>
    </div>
  </div>
</section>
<section class="px-block soft" id="materials">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal"><div class="px-kicker">Materials of Construction</div><h2>Some of the materials we have worked with.</h2></div>
    <div class="px-mats px-reveal"><h3>Materials We Fabricate, Form &amp; Machine</h3><ul><li>Nickel alloys — Ni 200, Monel, Hastelloys, Inconels, Incoloys</li><li>6-Moly materials</li><li>Copper alloys</li><li>Clad materials</li><li>Stainless steels</li><li>All duplex &amp; super duplex stainless</li><li>Titanium, zirconium &amp; tantalum</li><li>All carbon steels, including low-temperature</li><li>Customer-specific proprietary materials</li></ul></div>
  </div>
</section>
<!-- ===== CTA band ===== -->
<section class="ht-cta-band" style="margin-top:0">
  <div class="ht-wrap">
    <div>
      <h2>Have a challenging material spec?</h2>
      <p>From titanium to proprietary alloys, our shop has probably welded it before. Tell us what your process requires.</p>
    </div>
    <div class="ht-ctas">
