...
@section('description', "Every Need Navigator module, grouped and explained — client records to reporting — all configured to your agency's programs, forms, and vocabulary.")
            ...
            <div class="module-index features-hub">
                ...
                <div class="module-row reveal">
                    <div class="module-head">
                        ...
                        <p>The daily work of helping someone: a request comes in, a supervisor approves it, dollars move, and the record proves it. Assistance requests climb a clear status ladder — pending, review, approval, all the way to voucher printed — with funding pools that tie every dollar to a funder or program and warn when allocations don't reconcile.</p>
