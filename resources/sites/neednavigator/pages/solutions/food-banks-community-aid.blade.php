        ...
        <div class="container">
            ...
            <div class="caps">
                ...
                <div class="cap reveal">
                    ...
                    <p>Your agency defines its own catalog of resources, financial or non-financial, and every distribution is logged against it with a type and quantity. Requests move through a clear status ladder that staff can update right from the live grid, and a smart button records your standard distribution in one tap: the visit and the request together, pre-filled.</p>
                </div>
                <div class="cap reveal">
