...
<title>Employment - Harris Thermal</title>
<meta name="description" content="Join Harris Thermal in Newberg, Oregon — hiring mechanical engineers, estimators, journeyman mechanics, welder/fitters, and machinists.">
...
.px-hero .bg{position:absolute;inset:0;background:url('/sites/harristhermal/wp-content/uploads/2022/06/20211230_1348040-scaled.jpg') center/cover no-repeat;z-index:-2;transform:scale(1.04);animation:px-kb 16s ease-in-out infinite alternate}
...
<meta property="og:title" content="Employment - Harris Thermal">
<meta property="og:url" content="/employment/">
<meta property="og:image" content="/sites/harristhermal/wp-content/uploads/2022/06/harris_pressure_vessel-scaled.jpg">
<meta property="og:description" content="Join Harris Thermal in Newberg, Oregon — hiring mechanical engineers, estimators, journeyman mechanics, welder/fitters, and machinists.">
<script type="application/ld+json">{"@@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"/"},{"@type":"ListItem","position":2,"name":"Employment","item":"/employment/"}]}</script>
</head>
<body>
...
<section class="px-hero">
  ...
  <div class="ht-wrap">
    <div class="px-hero-inner">
      <span class="px-eyebrow">Careers · Newberg, Oregon</span>
      <h1>Build equipment <em>the world relies on.</em></h1>
      <p class="lead">Located in the heart of Oregon wine country, Harris Thermal has spent 135+ years building high-quality equipment, proudly made in the USA — supporting clean water, clean energy, high tech, and battery recycling worldwide.</p>
      <div class="px-ctas">
        <a class="px-btn px-btn-primary" href="/get-a-quote/">Get a Quote</a>
        <a class="px-btn px-btn-ghost" href="#positions">Open Positions</a>
      </div>
    </div>
  </div>
</section>
...
<section class="px-block">
  <div class="ht-wrap px-split">
    <div class="px-reveal">
      <div class="px-kicker">Why Work Here</div>
      <h2>A dynamic, team-oriented environment that values people and families.</h2>
      <p>We're looking for motivated people who want to learn a highly valuable trade in an ever-growing market. Because we perform a full array of services in-house, there are many opportunities for advancement and exposure to additional functions within the company.</p>
      <p>Harris Thermal is an equal opportunity employer. We also consider applications from iron workers and pipe fitters, and offer entry-level positions for those with mechanical aptitude, shop knowledge, and the ability to work safely.</p>
      <div class="px-ctas" style="margin-top:24px">
        <a class="px-btn px-btn-primary" href="/employment-application/">Apply Online</a>
        <a class="px-btn" style="background:var(--ht-bg-soft);color:var(--ht-navy)" href="tel:503-538-1260">Call (503) 538-1260</a>
      </div>
    </div>
    <div class="px-photo px-reveal">
      <img src="/sites/harristhermal/wp-content/uploads/2022/06/20211229_093915-1024x768.jpg" alt="Fabrication work at Harris Thermal" loading="lazy">
      <div class="px-badge"><div class="n">135+ yrs</div><div class="l">And still growing</div></div>
    </div>
  </div>
</section>
<section class="px-block soft" id="positions">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal"><div class="px-kicker">Open Positions</div><h2>Roles we're hiring for now.</h2></div>
    <div class="px-whys"><div class="px-why px-reveal"><h4>Mechanical Engineer</h4><p>Design pressure vessels and heat exchangers with our in-house engineering team.</p></div><div class="px-why px-reveal"><h4>Estimator</h4><p>Scope and price custom fabrication projects across every industry we serve.</p></div><div class="px-why px-reveal"><h4>Journeyman Mechanic</h4><p>Keep a 50,000 sq ft fabrication facility and its heavy equipment running.</p></div><div class="px-why px-reveal"><h4>Welder / Fitter</h4><p>GMAW, GTAW, FCAW, and SAW work on exotic alloys and code vessels.</p></div><div class="px-why px-reveal"><h4>Machine Operators / Machinists</h4><p>Run CNC gantry mills, boring mills, and drilling centers.</p></div><div class="px-why px-reveal"><h4>Entry Level</h4><p>Mechanical aptitude and a safe work ethic? We will teach you a trade.</p></div></div>
    <div style="text-align:center;margin-top:36px" class="px-reveal">
      <a class="px-btn px-btn-primary" href="/employment-application/">Fill Out Our Online Application</a>
    </div>
  </div>
</section>
<!-- ===== CTA band ===== -->
<section class="ht-cta-band" style="margin-top:0">
  <div class="ht-wrap">
    <div>
      ...
      <p>Fill out our online employment application, or call (503) 538-1260 to learn more about opportunities at Harris Thermal.</p>
    </div>
    <div class="ht-ctas">
