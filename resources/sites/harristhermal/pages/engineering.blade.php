...
<title>Engineering - Harris Thermal</title>
<meta name="description" content="In-house mechanical and thermal design to ASME Section VIII, B31.1, PED/CE, API 620/650, TEMA, and CRN — using Compress, PV Elite, Aspen EDR, and more.">
...
.px-hero .bg{position:absolute;inset:0;background:url('/sites/harristhermal/wp-content/uploads/2022/06/20211229_093915-scaled.jpg') center/cover no-repeat;z-index:-2;transform:scale(1.04);animation:px-kb 16s ease-in-out infinite alternate}
...
<link rel="canonical" href="/engineering/">
<meta property="og:type" content="website">
<meta property="og:site_name" content="Harris Thermal">
<meta property="og:title" content="Engineering - Harris Thermal">
<meta property="og:url" content="/engineering/">
<meta property="og:image" content="/sites/harristhermal/wp-content/uploads/2022/06/harris_pressure_vessel-scaled.jpg">
<meta property="og:description" content="In-house mechanical and thermal design to ASME Section VIII, B31.1, PED/CE, API 620/650, TEMA, and CRN — using Compress, PV Elite, Aspen EDR, and more.">
<script type="application/ld+json">{"@@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"/"},{"@type":"ListItem","position":2,"name":"Engineering","item":"/engineering/"}]}</script>
</head>
<body>
...
<section class="px-hero">
  ...
  <div class="ht-wrap">
    <div class="px-hero-inner">
      <span class="px-eyebrow">Capabilities · Engineering</span>
      <h1>Designed in-house, <em>to any code.</em></h1>
      <p class="lead">Our full in-house engineering staff expertly designs your most complicated pressure vessel or heat exchanger — and thermally optimizes it for an efficient, economical solution matched to your needs.</p>
      <div class="px-ctas">
        <a class="px-btn px-btn-primary" href="/get-a-quote/">Get a Quote</a>
        <a class="px-btn px-btn-ghost" href="#codes">Codes &amp; Software</a>
      </div>
    </div>
  </div>
</section>

<section class="px-block" id="codes">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal"><div class="px-kicker">Design Capability</div><h2>Mechanical and thermal design under one roof.</h2><p>Tell us your needs and we will provide an efficient and economical design — for pressure vessels, heat exchangers, and custom equipment alike.</p></div>
    <div class="px-types">
      <div class="px-type px-reveal"><h3>Design Codes</h3><ul>
        <li><strong>ASME Section VIII, Division 1</strong>&ldquo;U&rdquo; &amp; &ldquo;R&rdquo; stamps</li>
        <li><strong>ASME B31.1 Power Piping</strong>&ldquo;PP&rdquo; stamp</li>
        <li><strong>Pressure Equipment Directive</strong>&ldquo;CE&rdquo; stamp for EU projects</li>
        <li><strong>API 620 / 650</strong>&ldquo;API&rdquo; stamp for storage tanks</li>
        <li><strong>TEMA</strong>Tubular Exchanger Manufacturers Association standards</li>
        <li><strong>CRN</strong>Canadian registration for all provinces</li>
      </ul></div>
      <div class="px-type px-reveal"><h3>Design Software</h3><ul>
        <li><strong>Compress</strong>Pressure vessel software by Codeware</li>
        <li><strong>DesignCalcs</strong>Pressure vessel design by CEI</li>
        <li><strong>PV Elite</strong>Vessel design &amp; analysis by Hexagon</li>
        <li><strong>AMETank</strong>API tank design software</li>
        <li><strong>Aspen EDR</strong>Thermal &amp; mechanical exchanger design</li>
        <li><strong>NozzlePRO</strong>FEA by Paulin Research Group</li>
      </ul></div>
      <div class="px-type px-reveal"><h3>Beyond the Standard</h3><ul>
        <li><strong>Thermal Optimization</strong>Heat exchangers designed and optimized for your exact duty</li>
        <li><strong>Custom Equipment</strong>Design capability well beyond vessels and exchangers</li>
        <li><strong>In-House Tools</strong>Developed software augmenting commercial packages</li>
        <li><strong>Stringent Specs</strong>Complex configurations to your most demanding requirements</li>
      </ul></div>
    </div>
  </div>
</section>
...
<section class="ht-cta-band" style="margin-top:0">
  <div class="ht-wrap">
    <div>
      ...
      <p>Send us your process conditions and specifications — our engineers will deliver an efficient, code-compliant design.</p>
    </div>
    <div class="ht-ctas">
