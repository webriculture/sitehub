...
<title>Other Fabrication - Harris Thermal</title>
<meta name="description" content="From B31.1 and B31.3 piping and alloy ducting to modular skids, ozone generators, and nuclear test equipment — Harris Thermal fabricates the custom equipment other shops call impossible.">
...
.px-hero .bg{position:absolute;inset:0;background:url('/sites/harristhermal/wp-content/uploads/2022/06/20170907_150839-scaled.jpg') center/cover no-repeat;z-index:-2;transform:scale(1.04);animation:px-kb 16s ease-in-out infinite alternate}
...
<link rel="canonical" href="/other-fabrication/">
<meta property="og:type" content="website">
<meta property="og:site_name" content="Harris Thermal">
<meta property="og:title" content="Other Fabrication - Harris Thermal">
<meta property="og:url" content="/other-fabrication/">
<meta property="og:image" content="/sites/harristhermal/wp-content/uploads/2022/06/harris_pressure_vessel-scaled.jpg">
<meta property="og:description" content="From B31.1 and B31.3 piping and alloy ducting to modular skids, ozone generators, and nuclear test equipment — Harris Thermal fabricates the custom equipment other shops call impossible.">
<script type="application/ld+json">{"@@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"/"},{"@type":"ListItem","position":2,"name":"Other Fabrication","item":"/other-fabrication/"}]}</script>
<script type="application/ld+json">{"@@context":"https://schema.org","@type":"Service","serviceType":"Custom Industrial Fabrication","description":"B31.1 and B31.3 code piping, alloy ducting, modular skids, ozone generators, ladders and platforms, and nuclear test equipment.","provider":{"@id":"/#organization"},"areaServed":{"@type":"Country","name":"United States"},"url":"/other-fabrication/"}</script>
<script type="application/ld+json">{"@@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is the difference between B31.1 and B31.3 piping?","acceptedAnswer":{"@type":"Answer","text":"ASME B31.1 covers power piping (boiler external piping, steam systems in power plants); B31.3 covers process piping in chemical, petroleum, and related plants. Harris Thermal fabricates to both codes and holds the ASME “PP” stamp for power piping."}},{"@type":"Question","name":"What is a modular process skid?","acceptedAnswer":{"@type":"Answer","text":"A modular skid is a complete process system — vessels, exchangers, pumps, piping, and controls — assembled and fit up on a structural frame in the fabricator’s shop, then shipped as a unit. Shop fit-up reduces on-site installation time, labor cost, and schedule risk compared to field assembly."}},{"@type":"Question","name":"Can you fabricate equipment when no standard design exists?","acceptedAnswer":{"@type":"Answer","text":"Yes — that’s a specialty. From nuclear test equipment to wave generators and concept-design specialty equipment, Harris Thermal takes on projects that land outside what most fabricators consider normal, with in-house engineering to take your concept to a buildable design."}},{"@type":"Question","name":"What is hard facing and when is it needed?","acceptedAnswer":{"@type":"Answer","text":"Hard facing is the application of wear-resistant material to component surfaces to extend service life in abrasive or high-wear applications — common in mining, slurry handling, and high-velocity flow services."}},{"@type":"Question","name":"Do you fabricate nuclear-qualified equipment?","acceptedAnswer":{"@type":"Answer","text":"Yes. Harris Thermal operates an NQA-1 quality program for nuclear-grade fabrication, including nuclear test equipment — see our NQA-1 nuclear page for the program’s scope."}}]}</script>
</head>
<body>
...
<section class="px-hero">
  ...
  <div class="ht-wrap">
    <div class="px-hero-inner">
      <span class="px-eyebrow">Products &amp; Services · Custom Fabrication</span>
      <h1>The custom equipment <em>other shops call impossible.</em></h1>
      <p class="lead">From nuclear test equipment to concept-design specialty equipment, Harris Thermal delivers projects that land well outside what most fabricators consider normal — on time and to the most stringent specifications.</p>
      <div class="px-ctas">
        <a class="px-btn px-btn-primary" href="/get-a-quote/">Get a Quote</a>
        <a class="px-btn px-btn-ghost" href="#gallery">See Our Work</a>
      </div>
    </div>
  </div>
</section>
...
<!-- ===== Intro split ===== -->
<section class="px-block">
  <div class="ht-wrap px-split">
    <div class="px-reveal">
      <div class="px-kicker">Your Trusted Fabrication Partner</div>
      <h2>Have a challenging custom piece of equipment?</h2>
      <p>Let Harris Thermal be your trusted fabrication partner to complete your project on time and with the highest quality while meeting the most stringent specifications.</p>
      <p>Because everything happens in our shop — from concept design through fit-up — we control quality and schedule end to end, and your equipment arrives onsite ready for fast installation.</p>
      <ul class="px-checks">
        <li>B31.1 &amp; B31.3 code piping</li>
        <li>Gored elbows &amp; alloy ducting</li>
        <li>Prefabricated pipe spools</li>
        <li>Complete skid packages with controls</li>
        <li>Shop fit-up to cut install time</li>
        <li>Nuclear test equipment</li>
      </ul>
    </div>
    <div class="px-photo px-reveal">
      <img src="/sites/harristhermal/wp-content/uploads/2022/06/20211230_1348040-scaled.jpg" alt="Custom fabrication at Harris Thermal" loading="lazy">
      <div class="px-badge"><div class="n">In-house</div><div class="l">Concept to completion</div></div>
    </div>
  </div>
</section>

<!-- ===== Product types ===== -->
<section class="px-block soft">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal">
      <div class="px-kicker">What We Build</div>
      <h2>If you can spec it, we can fabricate it.</h2>
    </div>
    <div class="px-types">
      <div class="px-type px-reveal">
        <div class="ico"><svg viewBox="0 0 24 24"><path d="M4 4h6v6H4zm0 10h6v6H4zm10 0h6v6h-6zm2-10h2v6h4l-5 6-5-6h4z"/></svg></div>
        <h3>Piping &amp; Ducting</h3>
        <p>Gored elbows, alloy ducting runs, B31.1 and B31.3 code piping, and prefabricated spools — fabricated to print and delivered ready to install.</p>
      </div>
      <div class="px-type px-reveal">
        <div class="ico"><svg viewBox="0 0 24 24"><path d="M3 17h18v4H3zm2-2V7l7-4 7 4v8h-3V9l-4-2.3L8 9v6z"/></svg></div>
        <h3>Modular Skids</h3>
        <p>Complete package systems fit up in our shop — structure, equipment, piping, and controls integrated and tested before they ship.</p>
      </div>
      <div class="px-type px-reveal">
        <div class="ico"><svg viewBox="0 0 24 24"><path d="M12 2a7 7 0 0 1 7 7c0 2.4-1.2 4-2.5 5.4-.9 1-1.5 1.7-1.5 2.6h-6c0-.9-.6-1.6-1.5-2.6C6.2 13 5 11.4 5 9a7 7 0 0 1 7-7zm-3 17h6v1.5a1.5 1.5 0 0 1-1.5 1.5h-3A1.5 1.5 0 0 1 9 20.5z"/></svg></div>
        <h3>Ozone Generators</h3>
        <p>Specialized ozone generation equipment built precisely to your specifications, drawing on decades of experience with demanding process equipment.</p>
      </div>
      <div class="px-type px-reveal">
        <div class="ico"><svg viewBox="0 0 24 24"><path d="M2 12c2-3 4-3 6 0s4 3 6 0 4-3 6 0v4c-2-3-4-3-6 0s-4 3-6 0-4-3-6 0zm0-7c2-3 4-3 6 0s4 3 6 0 4-3 6 0v4c-2-3-4-3-6 0s-4 3-6 0-4-3-6 0z"/></svg></div>
        <h3>Wave Generators</h3>
        <p>One-of-a-kind custom equipment engineered and fabricated to meet your specific requirements — even when no standard design exists.</p>
      </div>
      <div class="px-type px-reveal">
        <div class="ico"><svg viewBox="0 0 24 24"><path d="M7 2h3v20H7zm7 0h3v20h-3zm-7 4h10v2H7zm0 5h10v2H7zm0 5h10v2H7z"/></svg></div>
        <h3>Ladders &amp; Platforms</h3>
        <p>Save time and cost by having ladders and platforms fit up in our shop — reducing install time when your equipment arrives onsite.</p>
      </div>
      <div class="px-type px-reveal">
        <div class="ico"><svg viewBox="0 0 24 24"><path d="M12 2 4 6v6c0 5 3.4 8.7 8 10 4.6-1.3 8-5 8-10V6zm0 2.2 6 3v4.8c0 3.9-2.6 6.9-6 8-3.4-1.1-6-4.1-6-8V7.2z"/></svg></div>
        <h3>Hard Facing</h3>
        <p>Hard facing of critical components to extend service life in abrasive and high-wear applications.</p>
      </div>
    </div>
  </div>
</section>
...
<!-- ===== Callout ===== -->
<section class="px-block soft" style="padding-top:0">
  <div class="ht-wrap">
    <div class="px-callout px-reveal">
      <div>
        <h3>From nuclear-grade to never-been-built.</h3>
        <p>Our NQA-1 nuclear program and 50,000+ sq ft of fabrication floor mean we can take on the projects that don't fit anyone else's shop.</p>
      </div>
      <div class="facts">
        <div class="fact"><a href="/nqa1-nuclear/" style="color:#7db4f7;font-weight:700">NQA-1 nuclear fabrication →</a></div>
        <div class="fact"><a href="/capabilities/" style="color:#7db4f7;font-weight:700">Explore our capabilities →</a></div>
      </div>
    </div>
  </div>
</section>
...
<!-- ===== Gallery ===== -->
<section class="px-block" id="gallery">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal">
      <div class="px-kicker">Other Fabrication Gallery</div>
      <h2>Built on our floor. Proven in the field.</h2>
    </div>
    <div class="px-gallery">
      <a class="px-gitem px-reveal" href="/sites/harristhermal/wp-content/uploads/2022/06/20211229_093714.jpg"><img src="/sites/harristhermal/wp-content/uploads/2022/06/20211229_093714-700x300.jpg" alt="Custom fabrication project" loading="lazy"><span class="cap">Custom Fabrication</span></a>
      <a class="px-gitem px-reveal" href="/sites/harristhermal/wp-content/uploads/2022/06/20170907_150839-scaled.jpg"><img src="/sites/harristhermal/wp-content/uploads/2022/06/20170907_150839-scaled-700x300.jpg" alt="Alloy fabrication in the Harris Thermal shop" loading="lazy"><span class="cap">Alloy Fabrication</span></a>
      <a class="px-gitem px-reveal" href="/sites/harristhermal/wp-content/uploads/2022/06/20180329_094029-2.jpg"><img src="/sites/harristhermal/wp-content/uploads/2022/06/20180329_094029-2-700x300.jpg" alt="Specialty equipment build" loading="lazy"><span class="cap">Specialty Equipment</span></a>
      <a class="px-gitem px-reveal" href="/sites/harristhermal/wp-content/uploads/2022/06/20211229_094327.jpg"><img src="/sites/harristhermal/wp-content/uploads/2022/06/20211229_094327-700x300.jpg" alt="Piping and ducting fabrication" loading="lazy"><span class="cap">Piping &amp; Ducting</span></a>
      <a class="px-gitem px-reveal" href="/sites/harristhermal/wp-content/uploads/2022/06/20211230_1348040-scaled.jpg"><img src="/sites/harristhermal/wp-content/uploads/2022/06/20211230_1348040-scaled-700x300.jpg" alt="Large custom fabrication" loading="lazy"><span class="cap">Large Custom Build</span></a>
    </div>
  </div>
</section>
...
<!-- ===== FAQ ===== -->
<section class="px-block soft" id="faq">
  <div class="ht-wrap">
    <div class="px-sec-head">
      <div class="px-kicker">Frequently Asked Questions</div>
      <h2>Custom Fabrication FAQs</h2>
    </div>
    <div class="px-faq">
<details><summary>What is the difference between B31.1 and B31.3 piping?</summary><div class="a"><p>ASME B31.1 covers power piping (boiler external piping, steam systems in power plants); B31.3 covers process piping in chemical, petroleum, and related plants. Harris Thermal fabricates to both codes and holds the ASME &ldquo;PP&rdquo; stamp for power piping.</p></div></details>
<details><summary>What is a modular process skid?</summary><div class="a"><p>A modular skid is a complete process system &mdash; vessels, exchangers, pumps, piping, and controls &mdash; assembled and fit up on a structural frame in the fabricator&rsquo;s shop, then shipped as a unit. Shop fit-up reduces on-site installation time, labor cost, and schedule risk compared to field assembly.</p></div></details>
<details><summary>Can you fabricate equipment when no standard design exists?</summary><div class="a"><p>Yes &mdash; that&rsquo;s a specialty. From nuclear test equipment to wave generators and concept-design specialty equipment, Harris Thermal takes on projects that land outside what most fabricators consider normal, with in-house engineering to take your concept to a buildable design.</p></div></details>
<details><summary>What is hard facing and when is it needed?</summary><div class="a"><p>Hard facing is the application of wear-resistant material to component surfaces to extend service life in abrasive or high-wear applications &mdash; common in mining, slurry handling, and high-velocity flow services.</p></div></details>
<details><summary>Do you fabricate nuclear-qualified equipment?</summary><div class="a"><p>Yes. Harris Thermal operates an NQA-1 quality program for nuclear-grade fabrication, including nuclear test equipment &mdash; see our <a href="/nqa1-nuclear/">NQA-1 nuclear page</a> for the program&rsquo;s scope.</p></div></details>
    </div>
  </div>
</section>
...
<section class="ht-cta-band" style="margin-top:0">
  <div class="ht-wrap">
    <div>
      <h2>Have an unusual project in mind?</h2>
      <p>Bring us the equipment nobody else will quote. Our engineers will help you take it from concept to completion.</p>
    </div>
    <div class="ht-ctas">
