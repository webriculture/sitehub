        ...
        <div class="container">
            ...
            <div class="caps">
                <div class="cap reveal">
                    ...
                    <p>Courses hold the curriculum and its completion-fidelity threshold. Offerings are the runs families enroll in: online, in person, or hybrid, each with its own capacity and public page. Sessions generate from a weekday pattern, so the spring schedule takes minutes, not an afternoon.</p>
                </div>
                <div class="cap reveal">
                ...
                <div class="cap reveal">
                    ...
                    <p>Each course carries the attendance threshold your curriculum calls for, and completion is computed against it automatically. Facilitator credit overrides cover the nights life intervenes. Certificates generate as PDFs for everyone who qualifies, ready before certificate night.</p>
                </div>
                <div class="cap reveal">
