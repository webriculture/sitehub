...
<title>Oil and Gas Industry Solutions - Harris Thermal</title>
<meta name="description" content="Harris Thermal fabricates ASME, API, and TEMA compliant tanks, heat exchangers, condensers, and pressure vessels for upstream, midstream, and downstream oil and gas service.">
...
.px-hero .bg{position:absolute;inset:0;background:url('/sites/harristhermal/wp-content/uploads/2025/10/oil-gas-featured-scaled-e1761495631301.jpg') center/cover no-repeat;z-index:-2;transform:scale(1.04);animation:px-kb 16s ease-in-out infinite alternate}
...
<link rel="canonical" href="/oil-and-gas-industry-solutions/">
<meta property="og:type" content="website">
<meta property="og:site_name" content="Harris Thermal">
<meta property="og:title" content="Oil and Gas Industry Solutions - Harris Thermal">
<meta property="og:url" content="/oil-and-gas-industry-solutions/">
<meta property="og:image" content="/sites/harristhermal/wp-content/uploads/2022/06/harris_pressure_vessel-scaled.jpg">
<meta property="og:description" content="Harris Thermal fabricates ASME, API, and TEMA compliant tanks, heat exchangers, condensers, and pressure vessels for upstream, midstream, and downstream oil and gas service.">
<script type="application/ld+json">{"@@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"/"},{"@type":"ListItem","position":2,"name":"Oil and Gas Industry Solutions","item":"/oil-and-gas-industry-solutions/"}]}</script>
</head>
<body>
...
<section class="px-hero">
  ...
  <div class="ht-wrap">
    <div class="px-hero-inner">
      <span class="px-eyebrow">Industries Served · Oil &amp; Gas</span>
      <h1>Custom fabrication for <em>complex energy projects.</em></h1>
      <p class="lead">Equipment that performs reliably under extreme pressures, high temperatures, and highly corrosive environments — engineered and fabricated since 1885 for the most challenging energy applications.</p>
      <div class="px-ctas">
...
<section class="px-block" style="padding-bottom:56px">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal" style="margin-bottom:0;max-width:840px">
      <div class="px-kicker">Upstream · Midstream · Downstream</div>
      <h2>A trusted partner across the full oil and gas value chain.</h2>
      <p>We design and fabricate to industry-specific codes such as ASME Section VIII, TEMA, API 620, API 650, and API 660 — ensuring full compliance and peace of mind for EPCs, project managers, and facility operators across North America.</p><p>With extensive experience delivering large-scale process equipment, Harris Thermal has supported projects from Gulf Coast refineries to the Canadian oil sands. Lethal Service and Cyclic Service designs are available per ASME Section VIII, including fatigue life and weld integrity considerations for refinery and petrochemical duty.</p>
    </div>
  </div>
</section>
...
<section class="px-block soft" id="equipment">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal">
      ...
      <h2>Equipment for every stage of the energy sector.</h2>
    </div>
    <div class="px-types">
<div class="px-type px-reveal"><h3>Upstream</h3><ul><li><strong>Separation Systems</strong>Crude stabilization, dehydration units, and gas-liquid separation vessels.</li><li><strong>ASME Pressure Vessels</strong>High-specification process equipment for production service.</li></ul></div>
<div class="px-type px-reveal"><h3>Midstream</h3><ul><li><strong>Storage Tanks</strong>API 620 / 650 welded storage tanks and specialty containment solutions.</li><li><strong>Chillers &amp; Cooling Towers</strong>Supporting cryogenic, dehydration, and transport cooling applications.</li></ul></div>
<div class="px-type px-reveal"><h3>Downstream</h3><ul><li><strong>Shell &amp; Tube Heat Exchangers</strong>Designed to TEMA and API 660 standards for refinery and petrochemical service.</li><li><strong>Condensers &amp; Evaporators</strong>Optimized for heat recovery, separation, and process efficiency.</li><li><strong>Crystallizers</strong>For specialty petrochemical recovery and byproduct processes.</li></ul></div>
    </div>
  </div>
</section>
...
<section class="px-block soft" style="padding-top:0">
  <div class="ht-wrap">
    <div class="px-mats px-reveal">
      ...
      <ul><li>ASME Section VIII pressure vessels</li><li>TEMA &amp; API 660 heat exchangers</li><li>API 620 / 650 storage tanks</li><li>Carbon steel, stainless &amp; duplex</li><li>High-nickel alloys, titanium &amp; clad</li><li>Lethal &amp; cyclic service designs</li><li>Thermal &amp; mechanical design in-house</li><li>CAD, FEA &amp; stress simulation</li></ul>
    </div>
  </div>
</section>
...
<section class="px-block">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal">
      ...
      <h2>Why EPCs and operators choose Harris Thermal.</h2>
    </div>
    <div class="px-whys">
<div class="px-why px-reveal"><h4>Proven Legacy Since 1885</h4><p>More than a century of experience delivering custom engineered equipment for energy applications.</p></div>
<div class="px-why px-reveal"><h4>North American Footprint</h4><p>Strategically positioned to serve oil and gas hubs with responsive support.</p></div>
<div class="px-why px-reveal"><h4>Quality Assurance</h4><p>NDE, hydrotesting, and stringent weld procedures for critical applications.</p></div>
<div class="px-why px-reveal"><h4>Flexible Scale</h4><p>From single vessels to large multi-unit projects, we adapt to your project scope.</p></div>
<div class="px-why px-reveal"><h4>Trusted by EPCs &amp; End Users</h4><p>Supporting some of the most recognized names in energy and refining.</p></div>
<div class="px-why px-reveal"><h4>Engineered Solutions</h4><p>Thermal design, mechanical design, and project management from concept to completion.</p></div>
    </div>
  </div>
</section>
...
<section class="ht-cta-band" style="margin-top:0">
  <div class="ht-wrap">
    <div>
      <h2>Ready to support your next energy project?</h2>
      <p>Whether you need a single ASME vessel, a field of API tanks, or complex heat exchangers to TEMA and API 660 standards, our team has the expertise and capacity to deliver.</p>
    </div>
    <div class="ht-ctas">
