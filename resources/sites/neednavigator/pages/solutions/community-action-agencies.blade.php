...
@php
    $faqs = [
        [
            ...
            'a' => 'You load income thresholds by year, type — federal poverty level (FPL) or area median income (AMI) — geographic area, and household size, with a percentage multiplier for programs set at, say, 125 percent of poverty. Programs combine income rules with age ranges and required-field rules, and clients show as eligible or partially eligible. When new guidelines publish, a bulk tool generates next year\'s thresholds from the current year\'s.',
        ],
        [
        ...
        [
            ...
            'a' => 'Yes. Each agency runs its own copy of Need Navigator with its own private database — no shared tenancy, and cross-agency queries are impossible by construction. Client data is encrypted at rest on the application server, and every client database is backed up nightly to redundant, encrypted cloud storage with integrity verification on every run.',
        ],
    ];
        ...
        <div class="container">
            ...
            <div class="caps">
                ...
                <div class="cap reveal">
                    ...
                    <p>Requests move through a clear status ladder — pending, ready for review, approved, finalized, voucher printed — so supervisors have a queue, not a pile. Funding pools carry balances and date ranges by funder or program, one request can split across pools, and the system warns when allocations do not add up. The eligibility math prints right on the voucher.</p>
                </div>
                <div class="cap reveal">
                ...
                <div class="cap reveal">
                    ...
                    <p>Break demographics down by race, ethnicity, gender, language, and ZIP — the kind of breakdowns that support Community Services Block Grant (CSBG)-style funder reporting — and schedule delivery weekly or monthly, done before anyone asks. Per-report redaction levels keep personally identifiable information (PII) out of a board packet, and everything exports to Excel.</p>
                </div>
                <div class="cap reveal">
