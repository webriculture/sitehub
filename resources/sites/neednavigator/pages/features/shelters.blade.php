...
@section('content')
    ...
    <section class="section" style="padding-bottom: clamp(2rem, 4vw, 3rem)">
        <div class="container">
            ...
            <p class="lede">Homeless shelter bed management software should mirror the building itself. Need Navigator gives you floors, rooms, and beds you can actually see — and a reservation workflow that runs from booking to check-out, keeps families together, and leaves behind the stay records your reporting needs.</p>
        </div>
    </section>
    ...
    <section class="section section--wash">
        <div class="container">
            <aside class="vignette">
                ...
                <p>A family of four arrives at 9 p.m. The overnight coordinator checks the matrix: two adjoining rooms open on floor two. They book the family as a group — one action, four people, both rooms — and the beds flip to occupied on the floor plan behind them.</p>
