...
@section('content')
    ...
    <section class="section" style="padding-bottom: clamp(2rem, 4vw, 3rem)">
        <div class="container">
            ...
            <p class="lede">Referral tracking software for nonprofits tends to stop at "sent." Need Navigator follows through: the printed referral carries a QR (quick-response) code the receiving provider scans — no login, no account — to record who received the client and how it went, closing the loop with a timestamp. Behind it sits a real partner directory, a portal partners can log into, and an opt-in network for agencies that both run Need Navigator.</p>
        </div>
    </section>
                        ...
                        <div class="ui-referral">
                            ...
                            <div class="r-grid">
                                ...
                                <div class="r-qr">
                                    ...
                                    <span>Scan to record receipt &mdash; no login needed</span>
                                </div>
                            </div>
                            <div class="r-closure">
                                ...
                                <p><span class="r-when">Loop closed &mdash; Thu, Mar 5, 2:41 p.m.</span>Received by front-desk staff, who noted the household picked up a three-day food box.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <figcaption class="ui-caption">An illustration of a printed referral: where the client is headed and why, the QR code the receiving provider scans to record receipt &mdash; no login &mdash; and the loop closure that comes back with feedback and a timestamp.</figcaption>
            </figure>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="caps">
                ...
                <div class="cap reveal">
                    ...
                    <p>Referral reasons are your vocabulary, not ours, and each reason can carry automations — for example, sending a templated email the moment a referral is created.</p>
                </div>
                <div class="cap reveal">
                ...
                <div class="cap reveal">
                    ...
                    <p>Agencies that both run Need Navigator can opt in to work together: search and link shared clients, send referrals system-to-system, and hold shared live message threads — each agency keeping its own private database. It is a capability you can adopt, never a network you are placed into.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section section--wash">
        <div class="container">
            <aside class="vignette">
                ...
                <p>Two days later, someone at the pantry scans the QR code on the page — no login, no account — and records who received the family and their feedback. The loop closes with a timestamp the caseworker can see right on the referral. No phone tag, no wondering whether the family ever made it there.</p>
            </aside>
