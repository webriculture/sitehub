        ...
        <div class="container">
            ...
            <div class="caps">
                ...
                <div class="cap reveal">
                    ...
                    <p>Every enrollment is an episode with entry and exit dates and a record of who enrolled and who exited the client. Exit reasons are agency-defined and grouped into categories you choose — and at a shelter check-out, an exit reason can fire automations, including closing the enrollment.</p>
                </div>
                <div class="cap reveal">
        ...
        <div class="container">
            ...
            <div class="caps">
                ...
                <div class="cap reveal">
                    ...
                    <p>Send a templated email with variables and optional attachments, create a task, post a message to the need's thread, or enroll a client in — or close — a program from a visit or a shelter check-out.</p>
                </div>
            </div>
        </div>
    </section>
