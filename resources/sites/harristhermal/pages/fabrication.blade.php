...
<title>Custom ASME Fabrication Services | Harris Thermal</title>
<meta name="description" content="Custom ASME code fabrication in Newberg, Oregon — GMAW, GTAW, FCAW, and SAW welding, 100-ton crane capacity, CNC burning and plate rolls, all in-house with no subcontractors.">
...
.px-hero .bg{position:absolute;inset:0;background:url('/sites/harristhermal/wp-content/uploads/2022/06/20180209_142909-scaled.jpg') center/cover no-repeat;z-index:-2;transform:scale(1.04);animation:px-kb 16s ease-in-out infinite alternate}
...
<link rel="canonical" href="/fabrication/">
<meta property="og:type" content="website">
<meta property="og:site_name" content="Harris Thermal">
<meta property="og:title" content="Custom ASME Fabrication Services | Harris Thermal">
<meta property="og:url" content="/fabrication/">
<meta property="og:image" content="/sites/harristhermal/wp-content/uploads/2022/06/harris_pressure_vessel-scaled.jpg">
<meta property="og:description" content="Custom ASME code fabrication in Newberg, Oregon — GMAW, GTAW, FCAW, and SAW welding, 100-ton crane capacity, CNC burning and plate rolls, all in-house with no subcontractors.">
<script type="application/ld+json">{"@@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"/"},{"@type":"ListItem","position":2,"name":"Custom ASME Fabrication Services","item":"/fabrication/"}]}</script>
<script type="application/ld+json">{"@@context":"https://schema.org","@type":"Service","serviceType":"Custom ASME Code Fabrication","description":"ASME U and R stamp fabrication with GMAW, GTAW, FCAW, and SAW welding, 100-ton crane capacity, all in-house.","provider":{"@id":"/#organization"},"areaServed":{"@type":"Country","name":"United States"},"url":"/fabrication/"}</script>
</head>
<body>
...
<section class="px-hero">
  ...
  <div class="ht-wrap">
    <div class="px-hero-inner">
      <span class="px-eyebrow">Capabilities · Fabrication</span>
      <h1>No subcontractors. <em>No excuses.</em></h1>
      <p class="lead">More than 135 years of continuous operation and 50,000+ sq ft of manufacturing space. Everything — machining, burning, forming — happens in-house, so we control your project start to finish.</p>
      <div class="px-ctas">
...
<section class="px-block">
  <div class="ht-wrap px-split">
    <div class="px-reveal">
      <div class="px-kicker">Heavy Lift, High Skill</div>
      <h2>Custom ASME code fabrication, all in-house.</h2>
      <p>Harris Thermal is an ASME U- and R-stamp certified shop performing custom ASME fabrication for process industries since 1885. Our welders produce work that has impressed customers for years, welding GMAW, GTAW, FCAW, and SAW — and we keep a wide range of material in stock for that &ldquo;emergency&rdquo; delivery when it's needed.</p>
      <p>Fabrication bay #1 runs two 50-ton bridge cranes with 42 ft under hook; bay #2 adds two 30-ton bridge cranes with 41 ft under hook. Combined with 30 ft × 60 ft bay doors, we can lift and manipulate 200,000 pounds quickly and safely — leaving little we cannot fabricate.</p>
    </div>
    <div class="px-photo px-reveal">
      <img src="/sites/harristhermal/wp-content/uploads/2022/06/20180209_142912.jpg" alt="Heavy fabrication at Harris Thermal" loading="lazy">
      <div class="px-badge"><div class="n">100 Ton</div><div class="l">Overhead crane capacity</div></div>
    </div>
  </div>
</section>
<section class="px-block soft" id="equipment">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal"><div class="px-kicker">Fabrication Equipment</div><h2>The floor that makes it possible.</h2></div>
    <div class="px-mats px-reveal"><h3>Some of Our Fabrication Equipment</h3><ul><li>5-axis CNC burning table (6&Prime; thick × 188&Prime; × 510&Prime;)</li><li>3/4&Prime; × 120&Prime; hydraulic shear with CNC controls</li><li>Waterjet table (6&Prime; thick × 84&Prime; × 168&Prime;)</li><li>400-ton brake press × 16 ft with gooseneck</li><li>CNC plate rolls (to 1-5/8&Prime; × 120&Prime; alloy)</li><li>Fully automatic sub-arc seam welder</li><li>Welding manipulators (13 ft × 23 ft travel)</li><li>Welding positioners (to 22,000 lb)</li><li>Tank turning rolls (to 300 tons)</li><li>Plasma cutting machines</li><li>Orbital tube welders (to 2-1/2&Prime;)</li><li>Miller PipeWorks piping welders</li><li>MIG, TIG &amp; sub-arc welders</li><li>Heat exchanger retubing equipment</li></ul></div>
  </div>
</section>
<!-- ===== CTA band ===== -->
<section class="ht-cta-band" style="margin-top:0">
  <div class="ht-wrap">
    <div>
      <h2>Have a fabrication challenge?</h2>
      <p>Send us your drawings — with everything in-house, we'll quote quality and turnaround no subcontracted shop can match.</p>
    </div>
    <div class="ht-ctas">
