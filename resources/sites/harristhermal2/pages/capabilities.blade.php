...
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1"><title>Capabilities - Harris Thermal</title>
<meta name="description" content="Harris Thermal: 7 acres, 50,000+ sq ft of fabrication space, 200,000 lb lifting capacity, in-house machining to 16.5 ft diameter, full engineering, quality control, and logistics.">
...
<link rel="stylesheet" href="/sites/harristhermal2/assets/css/page-interior.css">
...
<link rel="canonical" href="https://ht2.demo.webriculture.com/capabilities/"><meta property="og:type" content="website">
<meta property="og:site_name" content="Harris Thermal">
<meta property="og:title" content="Capabilities - Harris Thermal">
<meta property="og:url" content="https://ht2.demo.webriculture.com/capabilities/">
...
<meta property="og:description" content="Harris Thermal: 7 acres, 50,000+ sq ft of fabrication space, 200,000 lb lifting capacity, in-house machining to 16.5 ft diameter, full engineering, quality control, and logistics.">
<script type="application/ld+json">{"@@context":"https://schema.org","@@type":"BreadcrumbList","itemListElement":[{"@@type":"ListItem","position":1,"name":"Home","item":"https://ht2.demo.webriculture.com/"},{"@@type":"ListItem","position":2,"name":"Capabilities","item":"https://ht2.demo.webriculture.com/capabilities/"}]}</script>
</head>
<body>
...
<!-- ===== Hero ===== -->
<section class="px-hero" style="--px-hero-bg:url('/sites/harristhermal2/wp-content/uploads/2022/06/20211230_1348040-scaled.jpg')">
  <div class="bg"></div>
  <div class="ht-wrap">
    <div class="px-hero-inner">
      <span class="px-eyebrow">Capabilities · Newberg, Oregon</span>
      <h1>Fabrication, machining and testing <em>under one roof.</em></h1>
      <p class="lead">Our 7-acre Newberg facility combines 50,000+ sq ft of fabrication space, 200,000 pounds of lifting capacity, a dedicated machine shop, and a full engineering staff — so we control quality and schedule from start to finish.</p>
      <div class="px-ctas">
        <a class="px-btn px-btn-primary" href="/get-a-quote/">Get a Quote</a>
        <a class="px-btn px-btn-ghost" href="#capabilities">Explore Capabilities</a>
      </div>
    </div>
  </div>
</section>
<section class="px-block" style="padding-bottom:56px">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal"><div class="px-kicker">The Facility</div><h2>Equipped for large-diameter, heavy-wall fabrication.</h2><p>Our fabrication bays are supported by a dedicated machine shop capable of drilling, milling, and turning up to 16.5 ft diameter, and a dedicated parts bay for bending, forming, burning, and waterjet cutting. We fabricate everything from carbon steel to nickel alloys and reactive metals like titanium — scrutinized by ASNT Level III certified quality control.</p></div>
    <div class="px-stats px-reveal">
      <div class="px-stat"><div class="n">7 acres</div><div class="l">Newberg campus</div></div>
      <div class="px-stat"><div class="n">50,000+</div><div class="l">Sq ft fabrication space</div></div>
      <div class="px-stat"><div class="n">200,000 lb</div><div class="l">Overhead lifting capacity</div></div>
      <div class="px-stat"><div class="n">16.5 ft</div><div class="l">Max machining diameter</div></div>
    </div>
  </div>
</section>
<section class="px-block soft" id="capabilities">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal"><div class="px-kicker">What We Do</div><h2>Fabrication capabilities built for demanding projects.</h2></div>
    <div class="px-inds"><a class="px-ind px-reveal" href="/fabrication/">
  <div class="thumb"><img src="/sites/harristhermal2/wp-content/uploads/2022/06/20180209_142909-scaled-700x300.jpg" alt="Fabrication" loading="lazy"></div>
  <div class="body"><h3>Fabrication</h3><p>100-ton overhead crane capacity, 30ft × 60ft bay doors, and welders certified in GMAW, GTAW, FCAW, and SAW. With everything in-house, we control every project start to finish.</p><span class="more">In-depth information</span></div>
</a><a class="px-ind px-reveal" href="/machining/">
  <div class="thumb"><img src="/sites/harristhermal2/wp-content/uploads/2022/06/20211202_144007-700x300.jpg" alt="Machining" loading="lazy"></div>
  <div class="body"><h3>Machining</h3><p>A fully capable dedicated machine shop — CNC tubesheet drilling, boring mills up to 16.5ft diameter, and waterjet cutting to TEMA tolerances.</p><span class="more">In-depth information</span></div>
</a><a class="px-ind px-reveal" href="/materials/">
  <div class="thumb"><img src="/sites/harristhermal2/wp-content/uploads/2022/06/20170907_150839-scaled-700x300.jpg" alt="Materials" loading="lazy"></div>
  <div class="body"><h3>Materials</h3><p>Stainless, nickel alloys, Monel, Hastelloy, Inconel, titanium, zirconium, and more — stocked at opportune prices and backed by 140+ years of forming and welding experience.</p><span class="more">In-depth information</span></div>
</a><a class="px-ind px-reveal" href="/engineering/">
  <div class="thumb"><img src="/sites/harristhermal2/wp-content/uploads/2022/06/20211229_093915-scaled-700x300.jpg" alt="Engineering" loading="lazy"></div>
  <div class="body"><h3>Engineering</h3><p>Full in-house mechanical and thermal design to ASME, TEMA, API, PED, and CRN — using Compress, PV Elite, Aspen, and more.</p><span class="more">In-depth information</span></div>
</a><a class="px-ind px-reveal" href="/quality-control-safety/">
  <div class="thumb"><img src="/sites/harristhermal2/wp-content/uploads/2022/06/25072-004-1-1024x768.jpg" alt="Quality Control" loading="lazy"></div>
  <div class="body"><h3>Quality Control</h3><p>ASNT Level III certified RT, PT, UT, and VT personnel performing most testing in-house, with Hartford Steam Boiler as our Authorized Inspection Agency.</p><span class="more">In-depth information</span></div>
</a><a class="px-ind px-reveal" href="/safety/">
  <div class="thumb"><img src="/sites/harristhermal2/wp-content/uploads/2022/08/20211202_144243-scaled-700x300.jpg" alt="Safety" loading="lazy"></div>
  <div class="body"><h3>Safety</h3><p>A written safety manual, continuous training, and environmentally conscious chemical handling — protecting our people, customers, and neighbors.</p><span class="more">In-depth information</span></div>
</a><a class="px-ind px-reveal" href="/logistics-and-shipping/">
  <div class="thumb"><img src="/sites/harristhermal2/wp-content/uploads/2022/06/0421200209-700x300.jpg" alt="Logistics & Shipping" loading="lazy"></div>
  <div class="body"><h3>Logistics &amp; Shipping</h3><p>Shipment planning and carrier coordination — plus in-house loading, shrink wrapping, and nitrogen purging — so logistics never control your schedule.</p><span class="more">In-depth information</span></div>
</a></div>
  </div>
</section>
...
<section class="ht-cta-band" style="margin-top:0">
  <div class="ht-wrap">
    <div>
      <h2>Ready to put our shop to work?</h2>
      <p>Tell us about your project and our team will show you what 140+ years of in-house capability can deliver.</p>
    </div>
    <div class="ht-ctas">
