...
<title>Resources - Harris Thermal</title>
<meta name="description" content="Learn about TEMA classifications (C, B, R), shell and tube heat exchanger types, and design standards — plus technical resources from Harris Thermal.">
...
.px-hero .bg{position:absolute;inset:0;background:url('/sites/harristhermal/wp-content/uploads/2022/06/20160707_101613-scaled.jpg') center/cover no-repeat;z-index:-2;transform:scale(1.04);animation:px-kb 16s ease-in-out infinite alternate}
...
<meta property="og:title" content="Resources - Harris Thermal">
...
<meta property="og:description" content="Learn about TEMA classifications (C, B, R), shell and tube heat exchanger types, and design standards — plus technical resources from Harris Thermal.">
<script type="application/ld+json">{"@@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"/"},{"@type":"ListItem","position":2,"name":"Resources","item":"/resources/"}]}</script>
</head>
<body>
...
<section class="px-hero">
  ...
  <div class="ht-wrap">
    <div class="px-hero-inner">
      <span class="px-eyebrow">Resources · Technical Library</span>
      <h1>Learn the standards <em>behind the equipment.</em></h1>
      <p class="lead">Heat exchangers are the workhorses of chemical plants and refineries. Understand the TEMA classifications and design standards that govern how they are built.</p>
      <div class="px-ctas">
        <a class="px-btn px-btn-primary" href="/get-a-quote/">Get a Quote</a>
        <a class="px-btn px-btn-ghost" href="/category/industry-insights/">Industry Insights</a>
      </div>
    </div>
  </div>
</section>
...
<section class="px-block">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal"><div class="px-kicker">Understanding TEMA</div><h2>What TEMA standards mean for your equipment.</h2><p>TEMA — the Tubular Exchanger Manufacturers Association — is a set of standards developed by leading shell and tube manufacturers, defining exchanger styles plus machining and assembly tolerances. Selecting a TEMA-compliant manufacturer assures you the equipment you install is built to defined specifications and criteria.</p></div>
    <div class="px-fig px-reveal">
      <img src="/sites/harristhermal/wp-content/uploads/2022/06/fig7.png" alt="Common shell and tube heat exchanger configurations (TEMA, 1999)">
      <p style="color:var(--ht-muted);font-size:.85rem;margin:10px 0 0;text-align:center">Figure 7.1 (TEMA, 1999) — commonly used heat exchanger configurations</p>
    </div>
    <div class="px-whys"><div class="px-why px-reveal"><h4>TEMA C — General Service</h4><p>The least restrictive and most widely used classification.</p></div><div class="px-why px-reveal"><h4>TEMA B — Chemical Service</h4><p>Adds requirements like confined gasket joints, spiral wound gaskets, and greater minimum thicknesses.</p></div><div class="px-why px-reveal"><h4>TEMA R — Refinery Service</h4><p>Similar to B — the most stringent requirements for severe refinery duty.</p></div></div>
    <div class="px-sec-head px-reveal" style="margin:44px auto 0">
      <p>TEMA designations describe the complete exchanger: in a <strong>TEMA Type BEM</strong>, the &ldquo;B&rdquo; is the front head, &ldquo;E&rdquo; the shell, and &ldquo;M&rdquo; the rear head design. Want to go deeper? Read our <a href="/2026/05/13/what-is-a-tema-heat-exchanger/">TEMA heat exchanger guide</a> and <a href="/2026/05/19/understanding-tema-classes-r-c-and-b/">TEMA classes explainer</a>, or browse all our <a href="/category/industry-insights/">Industry Insights</a>.</p>
    </div>
  </div>
</section>
<section class="px-block soft" id="gallery">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal"><div class="px-kicker">Resources Gallery</div><h2>Reference builds from our shop.</h2></div>
    <div class="px-gallery">
      <a class="px-gitem px-reveal" href="/sites/harristhermal/wp-content/uploads/2022/06/20180615_134340.jpg"><img src="/sites/harristhermal/wp-content/uploads/2022/06/20180615_134340-700x300.jpg" alt="Stainless steel tanks" loading="lazy"><span class="cap">20ft OD Stainless-Steel Tanks</span></a>
      <a class="px-gitem px-reveal" href="/sites/harristhermal/wp-content/uploads/2022/06/Vessel-Pictures-044-7.jpg"><img src="/sites/harristhermal/wp-content/uploads/2022/06/Vessel-Pictures-044-7-700x300.jpg" alt="Knocked down evaporator" loading="lazy"><span class="cap">Large Knocked Down (KD) Evaporator</span></a>
      <a class="px-gitem px-reveal" href="/sites/harristhermal/wp-content/uploads/2022/06/20180209_142909-scaled.jpg"><img src="/sites/harristhermal/wp-content/uploads/2022/06/20180209_142909-scaled-700x300.jpg" alt="Crane lift of evaporator" loading="lazy"><span class="cap">100,000+ lb Evaporator Lift</span></a>
      <a class="px-gitem px-reveal" href="/sites/harristhermal/wp-content/uploads/2022/06/20160707_101613-scaled.jpg"><img src="/sites/harristhermal/wp-content/uploads/2022/06/20160707_101613-scaled-700x300.jpg" alt="Hemispherical head heat exchanger" loading="lazy"><span class="cap">12ft OD HEX with Hemispherical Head</span></a>
    </div>
  </div>
</section>
<!-- ===== CTA band ===== -->
<section class="ht-cta-band" style="margin-top:0">
  <div class="ht-wrap">
    <div>
      ...
      <p>Our engineers are happy to talk TEMA classes, ASME requirements, and what they mean for your project.</p>
    </div>
    <div class="ht-ctas">
