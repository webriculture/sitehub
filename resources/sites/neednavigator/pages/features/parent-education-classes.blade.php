        ...
        <div class="container">
            ...
            <div class="caps">
                ...
                <div class="cap reveal">
                    ...
                    <p>Automatic reminders go out for every session by text message (SMS) and email, a few days ahead and on the day of class, with opt-in managed per offering. Nobody on staff spends Monday calling the roster.</p>
                </div>
                <div class="cap reveal">
                    ...
                    <p>Scanning the session's QR poster never reveals who is enrolled. Confirmed participants get a single-use, short-lived check-in link by text or email, households check in together, and confidential members are never disclosed. It is designed with domestic-violence survivors in mind.</p>
                </div>
                <div class="cap reveal">
    ...
    <section class="section section--wash">
        <div class="container">
            <aside class="vignette">
                ...
                <p>The facilitator never opens a laptop. From their phone they mark the room: present, present, late for the parent who slips in at 6:15, with a credit override so the session still counts. Then they enroll a walk-in on the spot. A quick session note, and the record is done before the chairs are folded. When the course wraps, completion computes against the fidelity threshold, and certificates generate as PDFs for everyone who met it.</p>
            </aside>
