...
@section('content')
        ...
        <div class="container">
            ...
            <div class="caps">
                ...
                <div class="cap reveal">
                    ...
                    <p>Every saved report carries a PII redaction level — PII is personally identifiable information — so the export you hand a board or an outside audience shows totals and breakdowns, not sensitive identifiers.</p>
                </div>
                <div class="cap reveal">
                    ...
                    <p>Every report type exports to Excel — and beyond reports, Excel export runs across roughly sixteen record types platform-wide, from clients and visits to billing batches and location logs.</p>
                </div>
                <div class="cap reveal">
                ...
                <div class="cap reveal">
                    ...
                    <p>Built-in analytics cover spending by program, resources distributed, funds remaining by funder, and requests over time — and a funder report aggregates funding-pool spending by calendar year.</p>
                </div>
                <div class="cap reveal">
                ...
                <div class="cap reveal">
                    ...
                    <p>Saved reports live in a library grouped by program, with reordering and batch management — and each definition carries its own visibility level: everyone, same program, or selected teams.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section section--wash">
        <div class="container">
            ...
            <p>What it gives you is the material those reports are made of. The data model is HMIS-adjacent — HMIS is the Homeless Management Information System, the record-keeping standard many housing funders expect — and the builder, the demographic and spending breakdowns, and Excel export on every report type are designed to support your funder reporting. You assemble what your funder asks for once; after that, it is a saved definition on a schedule.</p>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="caps">
                ...
                <div class="cap reveal">
                    ...
                    <p>Sidebar counts track needs awaiting action, pending referrals, today's visits and reservations, and open tasks and goals — and each one links straight to the filtered list it represents.</p>
                </div>
                <div class="cap reveal">
