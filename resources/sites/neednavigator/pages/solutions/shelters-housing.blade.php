        ...
        <div class="container">
            ...
            <div class="caps">
                ...
                <div class="cap reveal">
                    ...
                    <p>Check-out captures an exit reason your agency defined, grouped into categories. Automations can act on it — closing the program enrollment, sending an email, creating a task — and the enrollment episode keeps its entry and exit dates and who recorded them.</p>
                </div>
                <div class="cap reveal">
                    ...
                    <p>Field staff log a GPS-stamped location from the client's record in one tap. Locations cluster automatically into places supervisors can name, the map filters by worker, client, place, and date range, and every log exports to Excel — well-suited to Point-in-Time (PIT) count fieldwork.</p>
                </div>
                <div class="cap reveal">
    ...
    <section class="section section--wash">
        <div class="container">
            <aside class="vignette">
                ...
                <p>Outside, the outreach team works the cold. For each person who declines to come in, they open the client's record and log a GPS-stamped location in one tap; by morning the pins have clustered into places the supervisor can name and filter. When the director asks how the night went, the answer is already a report — bed nights by shelter, exits by reason — built from the records staff made while it was happening.</p>
            </aside>
