...
<title>Liquefied Natural Gas Solutions - Harris Thermal</title>
<meta name="description" content="Absorber towers, cryogenic exchangers, knock-out drums, and ASME vessels for LNG gas treatment, liquefaction, storage, and regasification.">
...
.px-hero .bg{position:absolute;inset:0;background:url('/sites/harristhermal/wp-content/uploads/2025/10/lng-featured-e1761496956673.jpg') center/cover no-repeat;z-index:-2;transform:scale(1.04);animation:px-kb 16s ease-in-out infinite alternate}
...
<link rel="canonical" href="/liquefied-natural-gas-equipment/">
<meta property="og:type" content="website">
<meta property="og:site_name" content="Harris Thermal">
<meta property="og:title" content="Liquefied Natural Gas Solutions - Harris Thermal">
<meta property="og:url" content="/liquefied-natural-gas-equipment/">
<meta property="og:image" content="/sites/harristhermal/wp-content/uploads/2022/06/harris_pressure_vessel-scaled.jpg">
<meta property="og:description" content="Absorber towers, cryogenic exchangers, knock-out drums, and ASME vessels for LNG gas treatment, liquefaction, storage, and regasification.">
<script type="application/ld+json">{"@@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"/"},{"@type":"ListItem","position":2,"name":"Liquefied Natural Gas Solutions","item":"/liquefied-natural-gas-equipment/"}]}</script>
</head>
<body>
...
<section class="px-hero">
  ...
  <div class="ht-wrap">
    <div class="px-hero-inner">
      <span class="px-eyebrow">Industries Served · LNG</span>
      <h1>Engineered for <em>cryogenic extremes.</em></h1>
      <p class="lead">LNG facilities cool gas to -163°C under continuous duty. Our absorbers, exchangers, and ASME vessels are built for exactly that — extreme temperatures, corrosive contaminants, and long service life.</p>
      <div class="px-ctas">
...
<section class="px-block" style="padding-bottom:56px">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal" style="margin-bottom:0;max-width:840px">
      <div class="px-kicker">Treatment · Liquefaction · Storage</div>
      <h2>Supporting the full LNG value chain.</h2>
      <p>The LNG process begins with pre-treatment of feed gas to remove impurities such as H₂S, CO₂, H₂O, mercury, and higher hydrocarbons, before cooling to cryogenic temperatures between -145°C and -163°C for storage and transport. Harris Thermal partners with LNG producers, EPCs, and OEMs to deliver the ASME-code equipment this demanding chain requires — including Lethal Service and Cyclic Service designs per ASME Section VIII.</p>
    </div>
  </div>
</section>
...
<section class="px-block soft" id="equipment">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal">
      ...
      <h2>From feed gas treatment to cryogenic storage.</h2>
    </div>
    <div class="px-types">
<div class="px-type px-reveal"><h3>Gas Treatment &amp; Pre-Conditioning</h3><ul><li><strong>Absorber Towers &amp; Columns</strong>CO₂, H₂S, and contaminant removal prior to liquefaction.</li><li><strong>Scrubber Vessels</strong>Particulates, acid gases, and mercury control.</li><li><strong>Separators &amp; Knock-Out Drums</strong>Gas-liquid separation before cryogenic cooling.</li></ul></div>
<div class="px-type px-reveal"><h3>Liquefaction &amp; Cryogenics</h3><ul><li><strong>Shell &amp; Tube Heat Exchangers</strong>Pre-cooling, sub-cooling, and refrigerant cycle integration.</li><li><strong>Condensers &amp; Chillers</strong>Applied in cascade and mixed-refrigerant systems.</li><li><strong>Evaporators</strong>Regasification, boil-off gas management, and solvent recovery.</li></ul></div>
<div class="px-type px-reveal"><h3>Storage &amp; Balance-of-Plant</h3><ul><li><strong>Cryogenic Storage Tanks</strong>Double-wall insulated vessels for safe storage and transport.</li><li><strong>ASME Pressure Vessels</strong>Refrigerants, solvents, and intermediate process fluids.</li><li><strong>Custom Skid Packages</strong>Integrated exchangers, pumps, and vessels for modular plant systems.</li></ul></div>
    </div>
  </div>
</section>
...
<section class="px-block soft" style="padding-top:0">
  <div class="ht-wrap">
    <div class="px-mats px-reveal">
      ...
      <ul><li>304L, 316L, duplex &amp; AL-6XN</li><li>High-nickel alloys for contaminants</li><li>Carbon steel structural applications</li><li>ASME Section VIII, Div. 1 certified</li><li>TEMA exchangers &amp; API 620/650 tanks</li><li>Lethal &amp; cyclic service designs</li></ul>
    </div>
  </div>
</section>
...
<section class="px-block">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal">
      ...
      <h2>A trusted partner to the global LNG industry.</h2>
    </div>
    <div class="px-whys">
<div class="px-why px-reveal"><h4>Proven LNG Experience</h4><p>Equipment for gas treatment, liquefaction, and storage service.</p></div>
<div class="px-why px-reveal"><h4>Cryogenic Durability</h4><p>Designed to withstand extreme cryogenic service and harsh contaminants.</p></div>
<div class="px-why px-reveal"><h4>Custom Engineering</h4><p>Each exchanger, vessel, or skid built to process-specific requirements.</p></div>
<div class="px-why px-reveal"><h4>Continuous-Duty Reliability</h4><p>Built for the nonstop duty cycles LNG facilities demand.</p></div>
<div class="px-why px-reveal"><h4>Modular Delivery</h4><p>Skid packages that simplify installation and reduce site labor.</p></div>
<div class="px-why px-reveal"><h4>Global Capabilities</h4><p>Supporting EPCs and OEMs across North America and abroad.</p></div>
    </div>
  </div>
</section>
...
<section class="ht-cta-band" style="margin-top:0">
  <div class="ht-wrap">
    <div>
      <h2>Building or upgrading an LNG facility?</h2>
      <p>From new liquefaction trains to facility upgrades, our cryogenic exchangers, absorbers, and ASME vessels deliver the reliability your project demands.</p>
    </div>
    <div class="ht-ctas">
