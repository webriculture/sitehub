...
<title>Safety - Harris Thermal</title>
<meta name="description" content="Harris Thermal is fully committed to a safe working environment, backed by a written safety manual, ongoing training, and environmentally conscious practices.">
...
.px-hero .bg{position:absolute;inset:0;background:url('/sites/harristhermal/wp-content/uploads/2022/08/20211202_144243-scaled.jpg') center/cover no-repeat;z-index:-2;transform:scale(1.04);animation:px-kb 16s ease-in-out infinite alternate}
...
<meta property="og:title" content="Safety - Harris Thermal">
...
<meta property="og:description" content="Harris Thermal is fully committed to a safe working environment, backed by a written safety manual, ongoing training, and environmentally conscious practices.">
<script type="application/ld+json">{"@@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"/"},{"@type":"ListItem","position":2,"name":"Safety","item":"/safety/"}]}</script>
</head>
<body>
...
<section class="px-hero">
  ...
  <div class="ht-wrap">
    <div class="px-hero-inner">
      <span class="px-eyebrow">Capabilities · Safety</span>
      <h1>Safety first. <em>Every shift, every project.</em></h1>
      <p class="lead">Providing a safe working environment for our employees and visiting customers — backed by a written safety manual and continuous training — is our first priority.</p>
      <div class="px-ctas">
        <a class="px-btn px-btn-primary" href="/get-a-quote/">Get a Quote</a>
        <a class="px-btn px-btn-ghost" href="#content">Learn More</a>
      </div>
    </div>
  </div>
</section>

<section class="px-block" id="content">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal"><div class="px-kicker">Our Commitment</div><h2>Protecting people, customers, and neighbors.</h2></div>
    <div class="px-whys"><div class="px-why px-reveal"><h4>Written Safety Program</h4><p>A comprehensive written safety manual governs every operation on our floor.</p></div><div class="px-why px-reveal"><h4>Continuous Training</h4><p>Ongoing employee training keeps safe work practices current across the facility.</p></div><div class="px-why px-reveal"><h4>Environmental Responsibility</h4><p>Conscious disposal practices for cleaning and pickling chemicals — following best practices for our employees and our neighbors alike.</p></div></div>
  </div>
</section>
<!-- ===== CTA band ===== -->
<section class="ht-cta-band" style="margin-top:0">
  <div class="ht-wrap">
    <div>
      <h2>Want to see our safety record?</h2>
      <p>We are proud of our safety culture. Ask us about our program, training, and environmental practices.</p>
    </div>
    <div class="ht-ctas">
