...
@section('description', 'Need Navigator is built by Webriculture, a Salem, Oregon web firm about 25 years in — in close partnership with the agencies that use it.')
...
@section('content')
    ...
    <section class="section" style="padding-bottom: clamp(2rem, 4vw, 3rem)">
        <div class="container">
            ...
            <p class="lede">Need Navigator is built by Webriculture, a web firm in Salem, Oregon — about twenty-five years in, and part of the Compass Visual family. The product is shaped by one working arrangement: the agencies that use it tell us what the work needs, and we build it with them.</p>
        </div>
    </section>
        ...
        <div class="container">
            <div class="hero-grid">
                <div>
                    ...
                    <p>We build it in close partnership with the agencies that use it. That is not a slogan; it is the development model. Caseworkers, front-desk staff, and program directors ask for what the work needs, and the product grows in that direction — which is why the features on this site read like a caseworker's day rather than a vendor's brochure.</p>
                </div>
                <div>
