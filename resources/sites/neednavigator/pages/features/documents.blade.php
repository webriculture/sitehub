...
@php
    $faqs = [
        [
            ...
            'a' => 'You decide, folder by folder and file by file. Visibility can be open to everyone at the agency, limited to staff in the client\'s program, or restricted to selected teams — and client-file downloads pass a program-security check on top of that. Role-based permissions govern who can manage documents in the first place.',
        ],
        [
        ...
        [
            ...
            'a' => 'Yes. Files attach to a client, a need, a visit, a task, or an organization — so an eviction notice can live on the assistance request it supports, and a sign-in sheet on the visit it documents. When you open that record later, its paperwork is already there.',
        ],
        [
            'q' => 'What kinds of files can merge into one PDF?',
            'a' => 'PDFs, images, and Office documents. Select the files on the client\'s record and they combine into a single PDF — which is how agencies assemble a complete application packet as one attachment instead of a loose stack of files.',
        ],
    ];
                        ...
                        <div class="ui-docinbox">
                            ...
                            <div class="di-detail">
                                ...
                                <div class="di-fields">
                                    ...
                                    <div class="di-field"><span class="di-label">Attach to</span><span class="di-value">Need &mdash; utility shut-off <span class="di-caret">&#9662;</span></span></div>
    ...
    <section class="section section--wash">
        <div class="container">
            <aside class="vignette">
                ...
                <p>So the caseworker's part takes minutes, not an afternoon. They select the five files and merge them into one PDF — a complete, legible packet instead of a loose stack of scans and photos.</p>
            </aside>
        </div>
    </section>
