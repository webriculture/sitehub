...
<title>Machining - Harris Thermal</title>
<meta name="description" content="CNC Quickmill gantry mills, boring mills to 16.5 ft diameter, and waterjet cutting to TEMA tolerances — all machining kept in-house at Harris Thermal.">
...
.px-hero .bg{position:absolute;inset:0;background:url('/sites/harristhermal/wp-content/uploads/2022/06/20211202_144007.jpg') center/cover no-repeat;z-index:-2;transform:scale(1.04);animation:px-kb 16s ease-in-out infinite alternate}
...
<link rel="canonical" href="/machining/">
<meta property="og:type" content="website">
<meta property="og:site_name" content="Harris Thermal">
<meta property="og:title" content="Machining - Harris Thermal">
<meta property="og:url" content="/machining/">
<meta property="og:image" content="/sites/harristhermal/wp-content/uploads/2022/06/harris_pressure_vessel-scaled.jpg">
<meta property="og:description" content="CNC Quickmill gantry mills, boring mills to 16.5 ft diameter, and waterjet cutting to TEMA tolerances — all machining kept in-house at Harris Thermal.">
<script type="application/ld+json">{"@@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"/"},{"@type":"ListItem","position":2,"name":"Machining","item":"/machining/"}]}</script>
</head>
<body>
...
<section class="px-hero">
  ...
  <div class="ht-wrap">
    <div class="px-hero-inner">
      <span class="px-eyebrow">Capabilities · Machining</span>
      <h1>Your schedule, <em>under our control.</em></h1>
      <p class="lead">We keep all machining in-house so your project never waits on an outside vendor. From CNC tubesheet drilling to 16.5-ft diameter boring, our dedicated machine shop delivers without excuses.</p>
      <div class="px-ctas">
...
<section class="px-block">
  <div class="ht-wrap px-split">
    <div class="px-reveal">
      <div class="px-kicker">Purpose-Built for Heat Exchangers</div>
      <h2>Drilling, reaming, and milling to exacting tolerances.</h2>
      <p>Because we fabricate shell and tube heat exchangers of every size, we've invested in a wide range of computer-controlled drilling equipment to drill, ream, and chamfer tubesheets and baffles.</p>
      <p>Our large-capacity boring mills turn tubesheet edges for weld prep and add serrated gasket surfaces to body flanges up to 16 ft 6 in diameter. CNC mills machine large flat surfaces, pass partition grooves, and o-ring gasket surfaces — and our 84&Prime; × 168&Prime; waterjet table cuts baffles to TEMA tolerances.</p>
    </div>
    <div class="px-photo px-reveal">
      <img src="/sites/harristhermal/wp-content/uploads/2022/06/20211202_143732.jpg" alt="CNC machining at Harris Thermal" loading="lazy">
      <div class="px-badge"><div class="n">16.5 ft</div><div class="l">Max turning diameter</div></div>
    </div>
  </div>
</section>
<section class="px-block soft" id="equipment">
  <div class="ht-wrap">
    <div class="px-sec-head px-reveal"><div class="px-kicker">Machining Equipment</div><h2>Heavy iron for heavy work.</h2></div>
    <div class="px-mats px-reveal"><h3>Some of Our Larger Machining Equipment</h3><ul><li>CNC Quickmill Intimidator — 120&Prime; × 120&Prime; travel, 138&Prime; clear under gantry</li><li>CNC Quickmill — 144&Prime; × 240&Prime; travel, 168&Prime; clear under gantry</li><li>CNC drilling/milling centers — to 120&Prime; × 160&Prime; in a single setup</li><li>Boring mills — to 60&Prime; height × 198&Prime; diameter</li><li>Waterjet table — 84&Prime; × 168&Prime;, baffles to TEMA tolerances</li><li>Full complement of manual lathes, drills, saws &amp; threaders</li></ul></div>
  </div>
</section>
<!-- ===== CTA band ===== -->
<section class="ht-cta-band" style="margin-top:0">
  <div class="ht-wrap">
    <div>
      <h2>Need precision machining — fast?</h2>
      <p>From tubesheets to large-diameter flanges, our in-house machine shop quotes with turnaround outside vendors cannot match.</p>
    </div>
    <div class="ht-ctas">
